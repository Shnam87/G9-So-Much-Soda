  ...
  <div id="wrapper" class="hfeed">
    <header id="header" class="header-black" role="banner">
      ...
      <nav id="site-navigation" class="main-navigation box" role="navigation">
        <button class="menu-toggle svg-container">
      ...
      <div class="icons-nav box">
        <?php if (is_user_logged_in()) : ?>
          <a class="svg-container" href="<?php echo site_url('/my-account/'); ?>">

            <svg xmlns="http://www.w3.org/2000/svg" height="48" width="48" fill="none">
        ...
        <?php endif; ?>
        <div class="icon-div">
          <a class="svg-container" href="<?php echo site_url('/cart/'); ?>">
          ...
          <a class="svg-container" href="<?php echo site_url('/search/'); ?>">
